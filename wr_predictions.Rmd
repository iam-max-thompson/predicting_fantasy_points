...
wrs <- within(wrs, {
  receptions[season < 2021] <- receptions[season < 2021] * 17 / 16
  targets[season < 2021] <- targets[season < 2021] * 17 / 16
  receiving_yards[season < 2021] <- receiving_yards[season < 2021] * 17 / 16 
  fantasy_points_ppr[season < 2021] <- fantasy_points_ppr[season < 2021] * 17 / 16 
  receiving_tds[season < 2021] <- receiving_tds[season < 2021] * 17 / 16 
  wopr[season < 2021] <- wopr[season < 2021] * 17 / 16
  receiving_air_yards[season < 2021] <- receiving_air_yards[season < 2021] * 17 / 16
  receiving_epa[season < 2021] <- receiving_epa[season < 2021] * 17 / 16
})
...
gsis <- read_csv("Downloads/draftinfo_gsis_fix.csv")
...
```{r}
# searching for fantasy football ranks
competition_ranks <- load_ff_rankings()

#%>% filter(ecr_type == "ro", pos %in% c("WR", "TE"))
competition_ranks$ecr_type <- factor(competition_ranks$ecr_type)
